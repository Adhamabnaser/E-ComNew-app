  ...
  return <>
    ...
    <form onSubmit={formikObj.handleSubmit} className={desgin.form_container + ' pb-1 mb-1'}>
      <div className={'flex pb-4' }>
        <p className={'text-3xl font-mono me-2 text-white border border-black rounded-tr-3xl rounded-bl-3xl px-3 py-1 bg-black'}>
          Sign Up,Now
        </p>
        <svg
     ...
     <div className='flex justify-end w-full mb-5'> 
        <button disabled={ formikObj.isValid === false || formikObj.dirty === false} type='submit' className='border bg-black text-slate-100 px-10 py-2 rounded-lg'>Register</button>
     </div>
